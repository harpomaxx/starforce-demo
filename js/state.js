...
// Define 2x2 sprite patterns for each base type (each array element is a sub-pixel)
const baseSprites = {
  hub: {
    // Command Hub - central core with connection points
    sprite: [
      ["#2c3e50", "#4a90e2"], // Top row: dark base, bright core
      ["#4a90e2", "#2c3e50"]  // Bottom row: bright core, dark base
    ],
  ...
  comm: {
    ...
    sprite: [
      ["#f39c12", "#ffffff"], // Top row: orange base, white antenna
      ["#d35400", "#f39c12"]  // Bottom row: dark orange, main orange
    ],
  ...
  dock: {
    ...
    sprite: [
      ["#2ecc71", "#27ae60"], // Top row: green structure
      ["#1e8449", "#2ecc71"]  // Bottom row: dark green bay, light green
    ],
  ...
  research: {
    ...
    sprite: [
      ["#9b59b6", "#ffffff"], // Top row: purple base, white equipment
      ["#7d3c98", "#9b59b6"]  // Bottom row: dark purple, main purple
    ],
  ...
  solar: {
    ...
    sprite: [
      ["#f1c40f", "#f39c12"], // Top row: yellow panels
      ["#d68910", "#f1c40f"]  // Bottom row: gold, yellow
    ],
  ...
  mining: {
    ...
    sprite: [
      ["#e67e22", "#d35400"], // Top row: orange structure
      ["#a0522d", "#e67e22"]  // Bottom row: brown drill, orange
    ],
  ...
  turret: {
    ...
    sprite: [
      ["#e74c3c", "#ffffff"], // Top row: red base, white barrel
      ["#922b21", "#e74c3c"]  // Bottom row: dark red, main red
    ],
  ...
  fuel: {
    ...
    sprite: [
      ["#1abc9c", "#85c1e9"], // Top row: teal tank, light blue
      ["#117a65", "#1abc9c"]  // Bottom row: dark teal, main teal
    ],
  ...
  cargo: {
    ...
    sprite: [
      ["#95a5a6", "#bdc3c7"], // Top row: gray container, light gray
      ["#566573", "#95a5a6"]  // Bottom row: dark gray, main gray
    ],
  ...
  sensor: {
    ...
    sprite: [
      ["#3498db", "#ffffff"], // Top row: blue base, white dish
      ["#2471a3", "#5dade2"]  // Bottom row: dark blue, light blue
    ],
